...
1. Скачать проект
   - git clone https://github.com/Zaraza88/SHORTENER.git
...
```
http://127.0.0.1:8000/index/ - Главная страница на которой осуществляется ~~укрощение~~ сокращение ссылок 
http://127.0.0.1:8000/list - Вывод вписка всех ссылок пользователя
